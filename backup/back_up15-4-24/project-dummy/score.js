...
function ce() {
    player += 1;
    console.log(player);
    document.getElementById("profil").src="/project-dummy/Profilbilder/Profilbild1.jpeg";
...
function cz() {
    player += 2;
    console.log(player);
    document.getElementById("profil").src="/project-dummy/Profilbilder/Profilbild2.jpg";
    toggleFolie('auswahl', 'zwei', 500)
}
...
function cd() {
    player += 3;
    console.log(player);
    document.getElementById("profil").src="/project-dummy/Profilbilder/Profilbild3.jpg";
    toggleFolie('auswahl', 'zwei', 500)
}
...
function cv() {
    player += 4;
    console.log(player);
    document.getElementById("profil").src="/project-dummy/Profilbilder/Profilbild4.jpg";
    toggleFolie('auswahl', 'zwei', 500)
}
...
function cf() {
    player += 5;
    console.log(player);
    document.getElementById("profil").src="/project-dummy/Profilbilder/Profilbild5.jpg";
    toggleFolie('auswahl', 'zwei', 500)
}
...
function cs() {
    player += 6;
    console.log(player);
    document.getElementById("profil").src="/project-dummy/Profilbilder/Profilbild6.jpg";
    toggleFolie('auswahl', 'zwei', 500)
}
